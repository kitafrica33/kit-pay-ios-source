...
Build 65 advertises `1.0.16-r65` in the authenticated device record and
`ios/1.0.16-r65` request header. The server enables the new visible encrypted-message
...
before ordinary sync callbacks may retry. This keeps build 65 compatible with a
