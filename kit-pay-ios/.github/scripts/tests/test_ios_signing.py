...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_54_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "54"', workflow)
        self.assertIn("v1.0.16-build54", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 54;"), 4)
