...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_56_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "56"', workflow)
        self.assertIn("v1.0.16-build56", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 56;"), 4)
