...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_44_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "44"', workflow)
        self.assertIn("v1.0.16-build44", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 44;"), 4)
