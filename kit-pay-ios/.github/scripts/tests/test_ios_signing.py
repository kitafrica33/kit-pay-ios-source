...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_51_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "51"', workflow)
        self.assertIn("v1.0.16-build51", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 51;"), 4)
