...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_32_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "32"', workflow)
        self.assertIn("v1.0.16-build32", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 32;"), 4)
