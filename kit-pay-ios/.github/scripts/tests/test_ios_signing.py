...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_55_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "55"', workflow)
        self.assertIn("v1.0.16-build55", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 55;"), 4)
