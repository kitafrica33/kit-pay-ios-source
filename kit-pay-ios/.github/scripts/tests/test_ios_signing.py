...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_57_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "57"', workflow)
        self.assertIn("v1.0.16-build57", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 57;"), 4)
