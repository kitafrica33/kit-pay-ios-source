...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_46_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "46"', workflow)
        self.assertIn("v1.0.16-build46", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 46;"), 4)
