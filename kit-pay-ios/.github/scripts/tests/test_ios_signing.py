...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_47_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "47"', workflow)
        self.assertIn("v1.0.16-build47", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 47;"), 4)
