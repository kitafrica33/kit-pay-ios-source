...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_49_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "49"', workflow)
        self.assertIn("v1.0.16-build49", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 49;"), 4)
