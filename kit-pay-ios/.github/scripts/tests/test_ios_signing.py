...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_40_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn("v1.0.16-build40", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 40;"), 4)
