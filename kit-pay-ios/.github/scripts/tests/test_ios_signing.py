...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_64_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "64"', workflow)
        self.assertIn("v1.0.16-build64", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 64;"), 6)
