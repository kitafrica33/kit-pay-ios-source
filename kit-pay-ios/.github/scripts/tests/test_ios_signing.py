...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_42_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "42"', workflow)
        self.assertIn("v1.0.16-build42", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 42;"), 4)
