...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_41_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "41"', workflow)
        self.assertIn("v1.0.16-build41", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 41;"), 4)
