...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_37_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "37"', workflow)
        self.assertIn("v1.0.16-build37", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 37;"), 4)
