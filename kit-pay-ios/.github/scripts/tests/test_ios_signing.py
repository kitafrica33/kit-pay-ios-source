...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_63_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "63"', workflow)
        self.assertIn("v1.0.16-build63", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 63;"), 6)
