...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_50_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn("v1.0.16-build50", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 50;"), 4)
