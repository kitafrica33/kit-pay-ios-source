...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_45_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "45"', workflow)
        self.assertIn("v1.0.16-build45", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 45;"), 4)
