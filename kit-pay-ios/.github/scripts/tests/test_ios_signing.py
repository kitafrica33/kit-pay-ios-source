...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_43_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "43"', workflow)
        self.assertIn("v1.0.16-build43", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 43;"), 4)
