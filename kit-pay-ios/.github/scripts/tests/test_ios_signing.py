...
class SigningConfigurationTests(unittest.TestCase):
    def test_build_48_release_identity_is_consistent(self) -> None:
        ...
        self.assertIn('default: "48"', workflow)
        self.assertIn("v1.0.16-build48", workflow)
        ...
        self.assertEqual(project.count("CURRENT_PROJECT_VERSION = 48;"), 4)
